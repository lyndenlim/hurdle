...
function SevenLetters({ textColor, bgColor, word, pronunciation, english, def, isFavorited, setIsFavorited, counter, setCounter, setLetterLength, gameState, setGameState, checked, setShouldFetch, isDarkMode, setIsDarkMode, showWinModal, setShowWinModal, showLoseModal, setShowLoseModal }) {
